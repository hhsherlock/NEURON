...
#define nrn_init _nrn_init__kir4
#define _nrn_initial _nrn_initial__kir4
#define nrn_cur _nrn_cur__kir4
#define _nrn_current _nrn_current__kir4
#define nrn_jacob _nrn_jacob__kir4
#define nrn_state _nrn_state__kir4
#define _net_receive _net_receive__kir4 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "k_ion");
 	...
 	ivoc_help("help ?1 kir4 C:/Users/savtc/Dropbox/Task2Astro/TestAstro/Kir4.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "inward rectifier potassium (Kir4) channel";
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ik = ( 0.001 ) * gkir * ( v - ek * NormK - va1 ) * sqrt ( ( ( ko ) / ( 1.0 ) ) / ( 1.0 + exp ( ( v - ek * NormK - va2 ) / va3 ) ) ) ;
   }
 _current += ik;
...
#if NMODL_TEXT
static const char* nmodl_filename = "Kir4.mod";
static const char* nmodl_file_text = 
