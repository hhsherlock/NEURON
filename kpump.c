...
#define nrn_init _nrn_init__kpump
#define _nrn_initial _nrn_initial__kpump
#define nrn_cur _nrn_cur__kpump
#define _nrn_current _nrn_current__kpump
#define nrn_jacob _nrn_jacob__kpump
#define nrn_state _nrn_state__kpump
#define _net_receive _net_receive__kpump 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "#na_ion");
 	...
 	ivoc_help("help ?1 kpump C:/Users/savtc/Dropbox/Task2Astro/TestAstro/kpump.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "kpump";
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ik = imax * ( 1.0 / pow( ( 1.0 + 7.3 / ko ) , 2.0 ) ) * ( 1.0 / pow( ( 1.0 + 10.0 / nai ) , 3.0 ) ) * ( ki / Krest - 1.0 ) ;
   }
 _current += ik;
...
#if NMODL_TEXT
static const char* nmodl_filename = "kpump.mod";
static const char* nmodl_file_text = 
  "TITLE kpump\n"
  "\n"
  "NEURON {\n"
